...
class Company(models.Model):
    ...
    file_electronic_signature = fields.Binary('Archivo Firma')
    ...
    contingency_key_ids = fields.One2many('res.company.contingency.key', 'company_id', 'Claves de Contingencia',
...
class CompanyContingencyKey(models.Model):
    ...
    company_id = fields.Many2one('res.company', 'Empresa', required=True, default=_get_company)
